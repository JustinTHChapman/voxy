...
public abstract class AbstractSectionRenderer <T extends Viewport<T>, J extends IGeometryData> {
    ...
    protected static void addDirectionalFaceTint(Shader.Builder<?> builder, ClientLevel cl) {
        // Use the shaded (true) value for each direction — these are the standard MC directional brightness factors.
        // UP=1.0, DOWN≈0.5, N/S≈0.8, E/W≈0.6. Using boolean comparison was wrong: UP always returns same value.
        builder.define("NO_SHADE_FACE_TINT", 1.0f);
        builder.define("UP_FACE_TINT", cl.getShade(net.minecraft.core.Direction.UP, true));
        builder.define("DOWN_FACE_TINT", cl.getShade(net.minecraft.core.Direction.DOWN, true));
        builder.define("Z_AXIS_FACE_TINT", cl.getShade(net.minecraft.core.Direction.NORTH, true));
        builder.define("X_AXIS_FACE_TINT", cl.getShade(net.minecraft.core.Direction.EAST, true));
        /*
